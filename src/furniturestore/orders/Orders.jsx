    ...
    <>
      ...
      <div className="sofa_light_dashboard_furniturestore_components_carttable">
        <table>
          <thead>
            <tr>
              <th style={{ paddingLeft: "35px" }} name="product">
                Product Name
              </th>
          ...
          <tbody>
            {data.map((d, k) => (
              ...
              >
                ...
                <td htmlFor="price" className="money">
                  {formatPrice(d[2])} RWF
                </td>
                <td htmlFor="quantity" className="money">
                  {d[3]}
                </td>
                <td htmlFor="total" className="money">
                  {formatPrice(d[2] * d[3])} RWF
                </td>
                <td htmlFor="customer" className="money">
                  {d[4]}
                </td>
                <td htmlFor="phone" className="money">
                  {d[5]}
                </td>
                <td htmlFor="date" className="money">
                  {d[6]}
                </td>
              </tr>
            ))}
